...
Main.prototype.getMatrixGhostFor = function(u) {
    if (u.getTypeName() !== "api.type.User") throw new Error("TODO: Cannot getIntentForTelegramUser() on " + u.getTypeName());

    // TODO: hardcoded
    return this._bridge.getIntentFromLocalpart("telegram_" + u.id);
};
