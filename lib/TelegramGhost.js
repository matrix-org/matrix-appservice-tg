...
TelegramGhost.prototype._onOneUpdate = function(update) {
    ...
    switch(type) {
        ...
        case "UpdateChatUserTyping":
            console.log(`UPDATE: chat user typing user_id=${update.user_id} chat_id=${update.chat_id}`);
            break;

        case "UpdateReadHistoryInbox":
        case "UpdateReadHistoryOutbox":
            // user did something - ignore it for now
            break;

        case "UpdateNewChannelMessage":
            console.log(`UPDATE: new channel message ${update.message}`);
            break;
        default:
